...
import { exportarSoatsExcel } from '../utils/exportExcel';
import type { ExportOptionType} from '../utils/exportExcel';
import type { ExportOptions } from '../utils/exportExcel';
import type { Soat } from '../../../../db/schema';

interface SoatsExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  soats: Soat[];
}

export function SoatsExportModal({ isOpen, onClose, soats }: SoatsExportModalProps) {
  ...
  const handleExport = () => {
    ...
    exportarSoatsExcel(soats, opciones);
    onClose();
  };
