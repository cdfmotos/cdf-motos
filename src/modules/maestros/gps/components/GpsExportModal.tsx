...
import { exportarGpsExcel } from '../utils/exportExcel';
import type { ExportOptionType, ExportOptions } from '../utils/exportExcel';
import type { GPS } from '../../../../db/schema';

interface GpsExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  gpsList: GPS[];
}

export function GpsExportModal({ isOpen, onClose, gpsList }: GpsExportModalProps) {
  ...
  const handleExport = () => {
    ...
    exportarGpsExcel(gpsList, opciones);
    onClose();
  };
