...
import { exportarMotosExcel  } from '../utils/exportExcel';
...
interface MotosExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  motos: Moto[];
}

export function MotosExportModal({ isOpen, onClose, motos }: MotosExportModalProps) {
  ...
  const handleExport = () => {
    ...
    exportarMotosExcel(motos, opciones);
    onClose();
  };
